...
namespace XMeshLib
{
	...
	public:
		HalfEdge()
		{
			m_edge = NULL; m_vertex = NULL; m_prev = NULL; m_next = NULL; m_face = NULL; m_traits = NULL;
			m_duplicated_use_num_when_trace = 0;		
		}
		~HalfEdge()
		{
			if (m_traits)
		...
		int &duplicated_use_num_when_trace()
		{
			return m_duplicated_use_num_when_trace;
		}
	...
	private:
		...
		std::string    m_string;
		TraitList *	   m_traits;
		int m_duplicated_use_num_when_trace;
	};
